...
import CloudClosetPage from './pages/CloudClosetPage';
    ...
    <Layout>
      <RequirePassword>
        <Routes>
          ...
          <Route path="/product/:id/customize" element={<TShirtDesignerPage />} />
          ...
          <Route path="/cloud-closet" element={<CloudClosetPage />} />
          <Route
            path="/admin"
            element={
              <AdminRoute>
